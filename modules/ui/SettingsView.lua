...
local THRESHOLDS = {
    ...
    { key = "autoRerollPct",    label = "Auto-reroll %",
      flavor = "Rerolls when the best pickable echo (after banishes) is below this threshold — not the sum of all three offers.",
      min = 0, max = 300, step = 1 },
    { key = "rerollGuardPct",   label = "Reroll guard %",
      flavor = "Blocks reroll if any single offered echo scores above this threshold, regardless of the best pickable score.",
      min = 0, max = 100, step = 1 },
